...
-  to improve we can have replications of db , for aws server (serverless) it will spin up another server so quickly 
-  what if shopify itself goes down , **this is a single point of failure** in such scenario it is important to show our customer a proper message , my data is not accessible please try again later
