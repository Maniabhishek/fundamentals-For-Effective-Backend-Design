...
- so here it wont create the copy of the db but for key it will update at the transaction level and read 2 in T2 will happen from original table and hence gets 17 once T1 is commited only then we get updated value
