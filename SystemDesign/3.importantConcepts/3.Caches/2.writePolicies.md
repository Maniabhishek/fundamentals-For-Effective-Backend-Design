...
- we can also keep db consistent based on number of updates for a particular key lets say {1:20, update: 0} updates to -> {1:30, update: 1} ....{1:90, update: 5} once update is 5 we can now update this value in db
