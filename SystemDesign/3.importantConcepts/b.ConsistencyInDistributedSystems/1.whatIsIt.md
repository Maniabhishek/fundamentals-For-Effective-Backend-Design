...
- user experience (lets say user likes a post and refreshes it and sees his like was registered and getting correct value , but in a case where users like was not registered immediately and takes time to update the count of likes then it might upset the users)
