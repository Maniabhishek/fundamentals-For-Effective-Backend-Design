...
- or when you have two servers one server connected to one db and another server to another db , then a request for x = x+10 comes and another server send x = x-10 to another db
